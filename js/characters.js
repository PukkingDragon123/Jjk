...
export const CHARACTERS = [
  {
    ...
    skills: [
      { id: "blue",    name: "Cursed Technique Lapse: Blue", short: "BLUE",   kind: "orb",   sub: "attract", dmg: 14, sfx: "blue", desc: "Attracts everything toward a point." },
      { id: "red",     name: "Cursed Technique Reversal: Red", short: "RED",  kind: "burst", sub: "repel",   dmg: 18, sfx: "red",  desc: "A violent repulsion blast." },
      { id: "barrage", name: "Blue Barrage",         short: "BLUE×", kind: "nails", dmg: 16, sfx: "blue", desc: "A volley of converging blue spheres." },
      { id: "bolt",    name: "Cursed Energy Bolt",   short: "BOLT",  kind: "burst", sub: "bolt", dmg: 15, sfx: "bolt", desc: "A fast jolt of raw cursed energy." },
      { id: "maxblue", name: "Lapse: Maximum Blue",  short: "MAX BLUE", kind: "orb", sub: "attract", dmg: 23, sfx: "blue", desc: "An overcharged, heavier Blue." },
      { id: "infinity", name: "Infinity",            short: "INFINITY", kind: "guard", dmg: 0, sfx: "ui", desc: "Neutral Limitless — a brief moment of invulnerability." },
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      { id: "flame",     name: "Flame Slash",   short: "FLAME",     kind: "slash", sfx: "fire", dmg: 17, desc: "A burning crimson cut." },
